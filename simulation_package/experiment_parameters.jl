...
const RAW_NAME_TO_NICE_NAME = OrderedDict{String,Symbol}(
    ...
    "majoritarianevaluationmetrics.pluratarianevaluation_utility_metrics_utility_from_winner_avg" => :plur_util_from_winner_avg,
    ...
    "majoritarianevaluationmetrics.pluratarianevaluation_utility_metrics_utility_from_maximizer_median_" => :plur_util_from_max_med,
    ...
    "proportionalevaluationmetrics.proportionalevaluation_strict_indicators_util_maxer_elected" => :prop_strict_util_max_elec,
    ...
    "proportionalevaluationmetrics.proportionalevaluation_qualified_indicators_util_maxer_elected" => :prop_qual_util_max_elec,
    ...
    "majoritarianevaluationmetrics.pluratarianevaluation_utility_metrics_utility_from_maximizer_avg" => :plur_util_from_max_avg,
    ...
    "proportionalevaluationmetrics.proportionalevaluation_strict_indicators_minority_govt_indicators_elected" => :prop_strict_min_govt_elec,
    ...
    "majoritarianevaluationmetrics.pluratarianevaluation_utility_metrics_utility_from_winner_median_" => :plur_util_from_winner_med,
    ...
    "proportionalevaluationmetrics.proportionalevaluation_qualified_indicators_minority_govt_indicators_elected" => :prop_qual_min_govt_elec,
    ...
    "majoritarianevaluationmetrics.majoritarianevaluation_utility_metrics_utility_from_winner_median_" => :major_util_from_winner_med,
