...
const RAW_NAME_TO_NICE_NAME = OrderedDict{String,Symbol}(
    ...
    "majoritarianevaluationmetrics.majoritarianevaluation_voting_efficiency_stats_condorcet_efficiency" => :major_cond_efficiency,
    ...
    "majoritarianevaluationmetrics.majoritarianevaluation_voting_efficiency_stats_n_condorcet_paradox" => :major_condorcet_paradox,
    ...
    "proportionalevaluationmetrics.proportionalevaluation_qualified_indicators_util_maxer_elected" => :prop_qual_util_maxer,
    ...
    "majoritarianevaluationmetrics.majoritarianevaluation_voting_efficiency_stats_smith_efficiency" => :major_smith_efficiency,
